...
export default $config({
  ...
  async run() {
    ...
    const lambdaFunction = new sst.aws.Function('PeterPortal Backend', {
    ...
    const forwardHostFunction = new aws.cloudfront.Function('CloudFrontFunction', {
              ...
              functionAssociations: [
                {
                  ...
                  functionArn: forwardHostFunction.arn,
                },
              ],
            },
          ];
